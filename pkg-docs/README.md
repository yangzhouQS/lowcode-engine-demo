...
│   └── README.md             # 模块概览文档
├── types/                   # Types 模块文档
│   ├── README.md             # Types 模块概览
│   ├── 01-src-index.ts.md     # 模块入口文件文档
│   ├── 02-src-editor.ts.md     # 编辑器核心类型文档
│   ├── 03-src-activity.ts.md   # 活动类型文档
│   ├── 04-src-code-intermediate.ts.md  # 代码中间表示类型文档
│   ├── 05-src-code-result.ts.md  # 代码结果类型文档
│   ├── 06-src-assets.ts.md      # 资源类型文档
│   ├── 07-event-index.ts.md    # 事件配置文档
│   ├── 08-event-node.ts.md     # 节点事件文档
│   ├── 09-event-prop.ts.md     # 属性事件文档
│   ├── README-已完成文档.md  # 已完成文档清单
│   ├── 文档对比清单.md        # 文档对比清单
│   ├── 工作总结.md          # 工作总结
│   └── 最终总结.md          # 最终总结
├── Vue3架构设计              # Vue3 低代码框架架构设计文档
│   └── Vue3低代码框架架构设计方案.md  # 完整的架构设计方案
