...
export class LowCodePluginManager implements ILowCodePluginManager {
  ...
  /**
   * register a plugin
   * @param pluginConfigCreator - a creator function which returns plugin config
   * @param options - plugin options
   * @param registerOptions - plugin register options
   */
  async register(
    ...
    // registerOptions maybe in second place
    ...
    // compat legacy way to declare pluginName
    // @ts-ignore
