import type { IPublicTypeCustomView, IPublicModelEditor, IPublicModelSettingTopEntry, IPublicApiSetters } from '@vue3-engine/types';
import { isCustomView } from '@vue3-engine/utils';
import { computed } from 'vue';
import type { ISettingEntry } from './setting-entry-type';
import type { ISettingField, SettingField } from './setting-field';
...
export class SettingTopEntry implements ISettingTopEntry {
  ...
  get(propName: string | number): ISettingField | null {
    ...
    return this._settingFieldMap[propName] || (new SettingField(this, { name: propName } as any));
  }
